define([
    ...
    return declare([ContentPane, serialize.Mixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        title: i18n.gettext("OAPIF service"),
        ...
        serializeInMixin: function (data) {
            if (data.oapifserver_service === undefined) { data.oapifserver_service = {}; }
            ...
            data.oapifserver_service.layers = array.map(store.getValues(this.itemModel.root, "children"), function (i) {
                return dump(i); });
        },

        deserializeInMixin: function (data) {
            var value = data.oapifserver_service.layers;
